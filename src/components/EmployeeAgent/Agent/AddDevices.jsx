...
export const AddDevices = ({ handleSubmit, addDevicesId, handleAddDevicesIdDetails, handleCheckDeviceId }) => {
    return (
        <Dialog>
                    ...
                    <div className="mt-2">
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <input
                                ...
                                value={addDevicesId}
                                onChange={handleAddDevicesIdDetails}
                                required
                            />
                        </div>
                        <button onClick={handleCheckDeviceId} className="bg-blue-600 hover:bg-blue-700 mt-3 text-white font-semibold py-2 px-5 rounded-md transition-all">Check</button>
                    </div>

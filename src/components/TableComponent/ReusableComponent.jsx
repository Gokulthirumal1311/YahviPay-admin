...
export default function ReusableComponent({ columns, data, actions }) {
    return (
        <div className="">
            <section className="">
                                                ...
                                                <tr key={index}>
                                                    ...
                                                    {columns.map((col) => (
                                                        ...
                                                        >
                                                            {col === "status" ? (
                                                                <span
                                                                    className={`inline-flex items-center px-2 py-1 text-xs font-medium rounded-full ${item[col] === "WORKING"

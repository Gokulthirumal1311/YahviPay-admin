...
const Modal = () => {
  return (
    <div className="p-6 grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {stores.map((store, index) => (
        <div
          key={store.merchantId}
          className="relative group bg-gradient-to-br from-white to-indigo-50 border border-gray-200 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 overflow-hidden"
        >
